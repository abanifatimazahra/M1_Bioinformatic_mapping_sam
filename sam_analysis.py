...
#__contact__ = ("fatimazhara@etu.umontpellier.fr","noelie;palermo@etu.umontpellier.fr")
#__version__ = "0.0.1"
#__date__ = "16/1&/2022"
            ...
            if decimal[n] <= int(flagRead):
                ...
                if decimalRead == 2:
                    for m in range(len(decimal)):
                        ...
                        elif decimalMate == 1 or decimalMate == 8 or decimalMate == 4:
                            noPairedRead[read[0]] = read[1]
                    break
                #If the decimal of the read is equal to only a 1 or to 8 or to 4
                #Then reads are not paired and will be stock in a new dictionanry
                elif decimalRead == 1 or decimalRead == 8 or decimalRead == 4:
                    noPairedRead[read[0]] = read[1]
